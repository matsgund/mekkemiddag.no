        ...
        <form method="POST" enctype="multipart/form-data" action="{{ action('PostController@update',$posts->id) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="" name="category">
                    <!-- Checks what user already has selected in database -->
                    <?php $selected=$posts->category; ?>
                    <option <?php if ($selected == "Bakverk") echo "selected"?> >Bakverk</option>
                    <option <?php if ($selected == "Hovedrett") echo "selected"?> >Hovedrett</option>
                    <option <?php if ($selected == "Dessert") echo "selected"?> >Dessert</option>
                </select>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" id="" name="temperature" placeholder="eksempel: 225" value="{{$posts->temperature}}">
            </div>
            <div class="form-group">
                <label for="Time_in_oven">Tid i ovn</label>
                <input type="number" class="form-control" id="" name="timer" placeholder="eksempel: 30" value="{{$posts->timer}}">
            </div>
            <br>

            <div class="form-group">
                <button type="submit" class="btn btn-lg mb-2" id="submitButton">  Oppdater  </button>
            </div>
